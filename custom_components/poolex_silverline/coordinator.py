...
class SilverlineCoordinator(DataUpdateCoordinator[DeviceState]):
    ...
    def _tick_runtime(self, state: DeviceState) -> None:
        ...
        """
        # Imported lazily to keep entity.py the only module that has to
        # know about HVACAction at import time — avoids circular-import
        # surprises if coordinator imports get reordered.
        from .entity import compute_hvac_action
